  ...
  return (
    <>
      <main className="bg-white min-h-screen text-black p-4">
        ...
        <h3 className="text-xl mb-2">Last updated: April 5, 2022</h3>
        <p className="mb-1">
        ...
        <h1 className="text-3xl mb-2 font-semibold">Interpretation and Definitions</h1>
        ...
        <ul>
          ...
          <li>
            <p className="mb-1">
              ...
              &quot;Our&quot; in this Agreement) refers to Lakshya Fest LDCE, L.D. College of Engineering, Ahmedabad, GJ
              380015 .
            </p>
          </li>
          <li>
          ...
          <li>
            <p className="mb-1">
              <strong>Website</strong> refers to Lakshya 2022, accessible from{' '}
              <Link rel="noreferrer" href="https://www.lakshyafestldce.com" target="_blank">
                https://www.lakshyafestldce.com
              </Link>
            </p>
          </li>
          <li>
        ...
        <h1 className="text-3xl mb-2 font-semibold">Collecting and Using Your Personal Data</h1>
        ...
        <ul>
          ...
          <li>
            <p className="mb-1">First name and last name</p>
          </li>
          <li>
        ...
        <h3 className="text-xl mb-2">Usage Data</h3>
        ...
        <h3 className="text-xl mb-2">Tracking Technologies and Cookies</h3>
        <p className="mb-1">
        ...
        <p className="mb-1">
          ...
          <Link href="https://www.freeprivacypolicy.com/blog/cookies/" rel="noreferrer" target="_blank">
            Cookies: What Do They Do?
          </Link>
          .
        </p>
        <p className="mb-1">We use both Session and Persistent Cookies for the purposes set out below:</p>
        <ul>
          <li>
            <p className="mb-1">
        ...
        <h3 className="text-xl mb-2">Business Transactions</h3>
        <p className="mb-1">
        ...
        <h3 className="text-xl mb-2">Law enforcement</h3>
        <p className="mb-1">
        ...
        <h3 className="text-xl mb-2">Other legal requirements</h3>
        <p className="mb-1">
        ...
        <h1 className="text-3xl mb-2 font-semibold">Children&apos;s Privacy</h1>
        <p className="mb-1">
        ...
        <h1 className="text-3xl mb-2 font-semibold">Links to Other Websites</h1>
        <p className="mb-1">
        ...
        <h1 className="text-3xl mb-2 font-semibold">Changes to this Privacy Policy</h1>
        <p className="mb-1">
        ...
        <ul>
          <li>
            ...
            <Link href="https://www.lakshyafestldce.com/contact" rel="noreferrer" target="_blank">
              Contact Us
            </Link>
          </li>
          <li>
            By writing us a mail on:{' '}
            <Link href="mailto:lakshyafestldce@gmail.com" rel="noreferrer" target="_blank">
              lakshyafestldce@gmail.com
            </Link>
          </li>
        </ul>
      </main>
